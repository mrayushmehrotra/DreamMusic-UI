...
const songs = [
  ...
  },
  {
    ...
    album: "Off the Wall",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGxDPpDZOBGGOYmQnfm_2ZbVSXYrmP8apkgw&s",
  },
  {
    id: "5",
    title: "Don't Stop 'Til You Get Enough",
...
const App = () => {
  ...
  return (
    <div className="mt-7  min-h-fit ">
      <div className="flex justify-between ml-8 mr-8" >

      <h2 className="text-2xl text-gray-300 font-bold ">Popular</h2>
      <h2 className="text-xl text-[#a59595] hover:text-gray-200 cursor-pointer font-bold ">See All</h2>
      </div>
      <div className="bg-gradient-to-b from-[#3F00000] to-black font-semibold text-white p-6 ">
        <div className="relative">
          {/* Header */}
          <div className="text-gray-400 flex justify-around border-b border-gray-600 pb-2">
            <p className="flex-1 ml-11">#</p>
          ...
          {/* Scrollable List */}
          <div className="overflow-y-auto container  h-80 ">
                    ...
                    <div className="w-10">
                      <p className="flex-1 ml-5">
                        {currentSongId === song.id ? (
                          ...
                          <span>{song.id}</span> // Wrap song.id in a span or directly output it
                        )}
                      </p>
                    </div>
